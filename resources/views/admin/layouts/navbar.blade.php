                                ...
                                <div class="tp-progress-wrap">
                                    <div class="tp-progress-item d-flex align-items-center">
                                        <div class="tp-progress-thumb">
                                            <img src="assets/img/dashboard/course/progress-course-thumb-1.jpg" alt="">
                                        </div>
                                        <div class="tp-progress-content">
                                            ...
                                            <h4 class="tp-progress-title"><a href="course-details-2.html">Fundamentals of Business Analysis</a></h4>
                                    ...
                                    <div class="tp-progress-item d-flex align-items-center">
                                        <div class="tp-progress-thumb">
                                            <img src="assets/img/dashboard/course/progress-course-thumb-2.jpg" alt="">
                                        </div>
                                        <div class="tp-progress-content">
                                            <div class="tp-progress-rate d-flex align-items-center">
                                                <div class="tp-progress-rating">
                                            ...
                                            <h4 class="tp-progress-title"><a href="course-details-2.html">Design System in Figma</a></h4>
                                            <p>Completed Lessons: <span> 4 of 2 lessons</span></p>
                                            <div class="tp-progress-bar d-flex align-items-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="tp-dashboard-course-details text-sm-end">
                                    <a href="instructor-create-new-course.html">Browse All Course <i class="fa-regular fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="tp-dashboard-course-list">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="tp-dashboard-course-item">
                                                <div class="tp-dashboard-course-name">
                                                    <h5 class="tp-dashboard-course-name-title">Product Design</h5>
                                                </div>
                                                <div class="tp-dashboard-course-enroll">
                                                    <span>45</span>
                                                </div>
                                        ...
                                        <li>
                                            <div class="tp-dashboard-course-item">
                                                <div class="tp-dashboard-course-name">
                                                    <h5 class="tp-dashboard-course-name-title">Graphic Design Masterclass</h5>
                                                </div>
                                                <div class="tp-dashboard-course-enroll">
                                                    <span>12</span>
                                                </div>
                                        ...
                                        <li>
                                            <div class="tp-dashboard-course-item">
                                                <div class="tp-dashboard-course-name">
                                                    <h5 class="tp-dashboard-course-name-title">Fundamentals of Business Analysis</h5>
                                                </div>
                                                <div class="tp-dashboard-course-enroll">
                                                    <span>22</span>
                                                </div>
                                        ...
                                        <li>
                                            <div class="tp-dashboard-course-item">
                                                <div class="tp-dashboard-course-name">
                                                    <h5 class="tp-dashboard-course-name-title">Design System in Figma</h5>
                                                </div>
                                                <div class="tp-dashboard-course-enroll">
                                                    <span>30</span>
                                                </div>
                                        ...
                                        <li>
                                            <div class="tp-dashboard-course-item">
                                                <div class="tp-dashboard-course-name">
                                                    <h5 class="tp-dashboard-course-name-title">3D Motion Design</h5>
                                                </div>
                                                <div class="tp-dashboard-course-enroll">
                                                    <span>08</span>
                                                </div>
