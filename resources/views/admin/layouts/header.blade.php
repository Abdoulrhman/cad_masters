...
<head>
    ...
    <title>Admin CAD Masters</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- Place favicon.ico in the root directory -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('build/assets/admin/img/logo/favicon.png')}}">

    <!-- CSS here -->
    <link rel="stylesheet" href="{{asset('build/assets/admin/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{asset('build/assets/admin/css/animate.css')}}">
    <link rel="stylesheet" href="{{asset('build/assets/admin/css/swiper-bundle.css')}}">
    <link rel="stylesheet" href="{{asset('build/assets/admin/css/slick.css')}}">
    <link rel="stylesheet" href="{{asset('build/assets/admin/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{asset('build/assets/admin/css/flatpickr.min.css')}}">
    <link rel="stylesheet" href="{{asset('build/assets/admin/css/font-awesome-pro.css')}}">
    <link rel="stylesheet" href="{{asset('build/assets/admin/css/spacing.css')}}">
    <link rel="stylesheet" href="{{asset('build/assets/admin/css/main.css')}}">
</head>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="tp-search-course-item mb-30">
                                            <div class="tp-search-course-thumb mb-5">
                                                <a href="course-details-2.html"><img src="{{asset('assets/admin/img/course/search/search-1.jpg')}}" alt=""></a>
                                            </div>
                ...
                <div class="cartmini__widget-item">
                    <div class="cartmini__thumb">
                        <a href="shop-details.html">
                            <img src="{{asset('build/')}}assets/admin/img/shop/product/shop-product-1.jpg" alt="">
                        </a>
                    </div>
    ...
    <div id="header-sticky" class="tp-header-2">
        <div class="container custom-container-larg">
            <div class="row align-items-center">
                <div class="col-xxl-8 col-xl-3 col-lg-6 col-6">
                    <div class="tp-header-2-right d-flex align-items-center">
                        <div class="tp-header-inner-logo tp-header-logo">
                            <a href="index.html">
                                <img src="{{asset('build/assets/admin/img/logo/logo-black.png')}}" alt="logo">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-2 col-lg-6 col-6">
                    <div class="tp-header-2-contact d-flex align-items-center justify-content-end">
                        <div class="tp-header-inner-login tp-header-user-hover">
                            <button><img src="{{asset('build/assets/admin/img/event/user.jpg')}}" alt=""></button>
                                ...
                                <div class="tp-header-user-content">
                                    <div class="tp-header-user-profile d-flex align-items-center">
                                        <div class="tp-header-user-profile-thumb">
                                            <img src="{{asset('build/assets/admin/img/event/user.jpg')}}" alt="">
                                        </div>
