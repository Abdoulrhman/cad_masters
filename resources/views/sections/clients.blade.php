<!-- team-area-start -->
<section class="team-area pt-10 mb-50">
    <div class="container">
        ...
        <div class="swiper clients-swiper tp-team-2-active wow fadeInUp" data-wow-delay=".5s" id="clients-swiper">
            ...
            <div class="tp-shop-author-btn" style="display: flex; justify-content: center; margin-top: 5px;">
