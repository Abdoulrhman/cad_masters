<!-- team-area-start -->
<section class="team-area pt-5 mb-50">
    <div class="container">
        ...
        <div class="swiper partners-swiper tp-team-2-active wow fadeInUp " data-wow-delay=".5s" id="partners-swiper">
                ...
                @foreach($partners as $partner)
                    <div class="swiper-slide" style="height: auto; display: flex; align-items: center; justify-content: center;">
                        <div class="tp-team-2-item">
                            <div class="tp-shop-author-item text-center mb-5"
            ...
            <div class="tp-shop-author-btn" style="
            display: flex; justify-content: center; margin-top: 5px;">
                <a href="about/authorization">All Partners <span><svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
