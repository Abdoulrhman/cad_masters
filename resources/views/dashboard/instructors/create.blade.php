                ...
                <div class="col-lg-9">
                    <div class="tpd-content-layout">
                        <div class="container">
                            ...
                            <form action="{{ route('dashboard.instructors.store') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="branch" class="form-label">Job Title</label>
                                        <input type="text" name="title" class="form-control" id="title"
                                            value="{{ old('title') }}">
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label for="image" class="form-label">Instructor Image (Optional)</label>
