        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="tp-shop-product-tab mb-60">
                   <h3 class="bold"><span><img src="assets/img/shop/shop-shape.svg" alt=""></span> Certificate awards & Thanking <span><img src="assets/img/shop/shop-shape.svg" alt=""></span></h3>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="tp-shop-product-item text-center mb-50">
                            <div class="tp-shop-product-thumb p-relative">
                                <a href="{{ asset('storage/' . $certificate->image) }}"><img src="{{ asset('storage/' . $certificate->image) }}" alt=""></a>
                                <h4 class="tp-shop-product-title"><a href="shop-details.html">{{$certificate->name}}</a></h4>
                            </div>
