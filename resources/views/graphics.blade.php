...
@section('title')
    ...
    <section class="tp-breadcrumb__area p-relative">
        <div class="tp-breadcrumb__bg" style="background: url('{{ asset('/assets/img/breadcrumb/Graphics.PNG') }}') no-repeat center / contain !important"></div>
    </section>
    ...
    <section class="course-area tp-course-wrapper mt-20 mb-100">
        <div class="container">
            <div class="row align-items-end">
                <div class="col-xxl-5 col-xl-6 col-lg-7">
                    <div class="tp-section mb-40">
                        <h3 class="tp-section-3-title">Graphics
                        <span>Courses
