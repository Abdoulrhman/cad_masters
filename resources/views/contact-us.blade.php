...
<section class="tp-breadcrumb__area pt-160 pb-150 p-relative z-index-1 fix">
    <div class="tp-breadcrumb__bg overlay" style="url('/assets/img/breadcrumb/Contact-Us.PNG') no-repeat center / cover; "{{-- data-background="{{asset ('/assets/img/breadcrumb/Contact-Us.PNG') }}"--}}></div>
</section>
