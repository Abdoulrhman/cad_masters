                            ...
                            <li class="tpd-table-head" style="background: #4fb469!important;">
                                <div class="tpd-table-row">
                                    <div class="tpd-quiz-info">
                                        <h4 class="tpd-table-title tbd-color" style="color: white!important;">Start & End Date</h4>
                                    </div>
                                        ...
                                        <div class="tpd-quiz-details">
                                            <div class="tpd-quiz-details-box d-flex">
                                                <div class="tpd-quiz-details-btn mr-15">
                                                    <a class="tpd-border-btn" href="{{ route('courses.register', $course) }}" target="_blank">
                                                        Register
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="tp-shop-product-item text-center mb-50">
                                            <div class="tp-shop-product-thumb p-relative">
                                                <a href="{{ $course->instructor && $course->instructor->image ? asset('storage/' . $course->instructor->image) : asset('assets/img/teacher/default.png') }}"><img src="{{ $course->instructor && $course->instructor->image ? asset('storage/' . $course->instructor->image) : asset('assets/img/teacher/default.png') }}" style="max-width: 160px;max-height: 160px" alt=""></a>
                                                <h5 class="pt-20">{{ $course->instructor ? $course->instructor->name : 'Instructor' }}"</h5>
                            ...
                            {{--<div class="row">
                                @foreach ($certificates as $certificate)
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="tp-shop-product-item text-center mb-50">
                                            <div class="tp-shop-product-thumb p-relative">
                                                <a href="{{ asset('storage/' . $certificate->image) }}"><img src="{{ asset('storage/' . $certificate->image) }}" alt="{{$certificate->name}}}"></a>
                                    ...
                                    <span>
                                        @if($course->outline_link)
                                            <a href="{!! $course->outline_link !!}" target="_blank">
                                                <img src="{{ asset('assets/img/breadcrumb/pdf-bg.png') }}" style="width: 50px!important;height: 50px!important;" alt=""> <a
                                                        href="{!! $course->outline_link !!}" target="_blank"></a> Download Course Content
                                            </a>
                                        @else
