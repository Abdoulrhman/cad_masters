...
@section('title')
    ...
    <section class="tp-breadcrumb__area p-relative">
        <div class="tp-breadcrumb__bg" style="background: url('{{ asset('/assets/img/breadcrumb/Architecture.PNG') }}') no-repeat center / contain !important"></div>
    </section>
    ...
    <section class="tp-breadcrumb__area pt-160 pb-150 p-relative z-index-1 fix">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="tp-breadcrumb__content">
                        <h3 class="tp-breadcrumb__title color">BIM Tracks Courses</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-end">
                <div class="col-xxl-5 col-xl-6 col-lg-7">
                    <div class="tp-section mb-40">
                        <h3 class="tp-section-3-title">BIM Tracks
                        <span>Courses
